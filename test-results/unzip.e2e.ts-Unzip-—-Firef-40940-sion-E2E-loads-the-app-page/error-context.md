...
- Name: unzip.e2e.ts >> Unzip — Firefox extension E2E >> loads the app page
- Location: tests/e2e/unzip.e2e.ts:84:3
...
```ts
  1   | /**
  2   |  * End-to-end test for the Unzip tool running inside a real Firefox WebExtension.
  3   |  *
